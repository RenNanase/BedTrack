    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <span
                                            class="w-6 h-6 flex items-center justify-center text-blue-600 font-bold mr-2">♂</span>
                                        <span class="text-sm">Male</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span
                                            class="w-6 h-6 flex items-center justify-center text-pink-600 font-bold mr-2">♀</span>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3 mb-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-gray-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                    ...
                    <div>
                        <div class="text-lg font-bold text-gray-900">{{ $totalCribs }}</div>
                        <div class="text-xs text-gray-500">Total Cribs</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                    ...
                    <div>
                        <div class="text-lg font-bold text-gray-900">{{ $availableCribs ?? 0 }}</div>
                        <div class="text-xs text-gray-500">Available Cribs</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        <div class="text-lg font-bold text-gray-900">{{ $bookedCribs ?? 0}}</div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        <div class="text-lg font-bold text-gray-900">{{ $occupiedCribs }}</div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-pink-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    ...
                    <div>
                        <div class="text-lg font-bold text-gray-900">{{ $housekeepingCribs }}</div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-3 flex items-center">
                    <div
                        class="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center text-white text-sm mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            <div class="p-5 border-b border-gray-200 bg-blue-50">
                ...
                <p class="text-sm text-gray-500">Recent baby discharges from Nursery Ward </p>
            </div>
            <div class="p-6">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        @if($discharge->gender)
                                        <span
                                            class="inline-flex items-center justify-center w-5 h-5 rounded-full {{ $discharge->gender == 'Male' ? 'bg-blue-100 text-blue-700' : 'bg-pink-100 text-pink-700' }} font-bold text-xs">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('transfers.index', ['type' => 'in']) }}"
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    ...
                                    $transfer->sourceBed->has_hazard ? '💀 Hazard' : '' }}
                                </p>
                            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('transfers.index', ['type' => 'out']) }}"
                        class="text-sm text-primary hover:text-primary-dark">
                        View All
                    </a>
                </div>
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    ...
                                    $transfer->sourceBed->has_hazard ? '☠️ Hazard' : '' }}
                                </p>
                            </div>
                            <span class="text-sm text-gray-500">
                                {{ $transfer->transferred_at->format('d M Y H:i') }}
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            <div class="p-5 border-b border-gray-200 bg-primary/5">
                ...
                <p class="text-sm text-gray-500">Visual overview of all rooms and beds in {{ $nurseryWard->ward_name }}</p>
            </div>

            <div class="p-6">
                @if($nurseryWard->ward_name === 'Nursery Ward')
                <!-- Nursery Room Layout -->
                <div class="border rounded-lg overflow-hidden shadow-sm">
                    <div class="bg-gray-50 px-4 py-3 border-b flex justify-between items-center">
                        <h3 class="font-medium text-gray-700">{{ $nurseryWard->rooms->first()->room_name }}</h3>
                        <span class="text-xs px-2 py-1 rounded-full bg-primary/10 text-primary">
                            Capacity: {{ $nurseryWard->rooms->first()->capacity }} Cribs
                        </span>
                    </div>

                    <div class="p-4">
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                            @foreach($nurseryWard->rooms->first()->beds->where('is_crib', true) as $crib)
                            <a href="{{ route('beds.show', $crib) }}" class="block border rounded-md overflow-hidden transition-transform hover:scale-105 hover:shadow-md {{
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="flex justify-between items-start">
                                        <p class="text-sm font-medium text-gray-700">{{ $crib->patient_name ?: 'Unknown'
                                            }}</p>
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span
                                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-pink-100 text-pink-700">
                                            ...
                                            @if($crib->gender)
                                            <span
                                                class="inline-flex items-center justify-center w-6 h-6 rounded-full {{ $crib->gender == 'Male' ? 'bg-blue-100 text-blue-700' : 'bg-pink-100 text-pink-700' }} font-bold">
                                                {{ $crib->gender == 'Male' ? '♂' : '♀' }}
                                            </span>
                                            @endif
                                        </div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        ...
                                        <span class="text-pink-600">
                                            @php
                                            $minutesRemaining =
                                            Carbon\Carbon::now()->diffInMinutes($crib->housekeeping_started_at->addHours(2));
                                            $hoursRemaining = floor($minutesRemaining / 60);
                                            $minutesLeft = $minutesRemaining % 60;

                                            if ($minutesRemaining <= 0) { $timeDisplay='Available soon' ; } elseif
                                                ($hoursRemaining> 0) {
                                                $timeDisplay = $hoursRemaining . ' hour' . ($hoursRemaining > 1 ? 's' :
                                                '') . ' ' . $minutesLeft . ' minute' . ($minutesLeft > 1 || $minutesLeft
                                                == 0 ? 's' : '');
                                                } else {
                                    ...
                                    <p class="text-sm text-gray-500 italic">
                                        No baby
                                        @if($crib->has_hazard)
                                        <span class="text-red-600 float-right text-1xl"
                                            title="{{ $crib->hazard_notes }}">
                                            ☠️
                                        </span>
                                        @endif
                                    </p>
