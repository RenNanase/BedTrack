                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $user->ward ? $user->ward->name : 'No Ward Assigned' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('users.edit', $user) }}" class="text-primary hover:text-primary/80 mr-3">Edit</a>
                                @if($user->id !== auth()->id())
